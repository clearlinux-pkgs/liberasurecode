...
%prep
%setup -q -n liberasurecode-1.6.0
pushd ..
cp -a liberasurecode-1.6.0 buildavx2
popd
pushd ..
cp -a liberasurecode-1.6.0 buildavx512
popd
...
/usr/lib64/haswell/liberasurecode.so.1.6.0
...
/usr/lib64/liberasurecode.so.1.6.0
